        ...
        <div className="fixed inset-0 z-[100] bg-black/95 flex items-end sm:items-center justify-center sm:p-4">
          <div className="bg-[#0B1120] border-t sm:border border-white/10 rounded-t-[2.5rem] sm:rounded-[2.5rem] w-full max-w-lg max-h-[90vh] overflow-hidden flex flex-col">
            <div className="p-6 border-b border-white/5 text-center relative">
              ...
              <h2 translate="no" className="notranslate text-lg font-black italic uppercase text-white">{pontoAberto.titulo}</h2>
            </div>
              ...
              <div className="flex justify-center gap-8 mb-10 mt-2">
                {pontoAberto.link_youtube && (
                  <button onClick={() => abrirLink(pontoAberto.link_youtube)} className="flex flex-col items-center gap-2 group bg-transparent border-none">
                    ...
                    <span className="text-[8px] font-black text-slate-500 uppercase tracking-widest">YouTube</span>
                  </button>
                )}
                {pontoAberto.link_spotify && (
                  <button onClick={() => abrirLink(pontoAberto.link_spotify)} className="flex flex-col items-center gap-2 group bg-transparent border-none">
                    ...
                    <span className="text-[8px] font-black text-slate-500 uppercase tracking-widest">Spotify</span>
                  </button>
                )}
              </div>

              <pre translate="no" className="notranslate whitespace-pre-wrap font-serif text-lg italic leading-relaxed text-slate-100 pb-10">
                {pontoAberto.letra}
              </pre>
            </div>
          </div>
